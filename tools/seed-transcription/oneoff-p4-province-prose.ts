 ...
 * `country.seed-data.ts` and now travels with the GE row in `../../src/database/seeds/countries/
 * asia.countries.ts` (moved by FU-PILOT-RETIRE) — a COMMENT, no value and no prose changed
 * there, so no country-lane transcription is involved.
 *
