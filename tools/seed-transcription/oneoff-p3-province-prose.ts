 ...
 * Thirteen fields remain in this entry point after later ownership transfers. This wave landed
 * with twenty fields: Mersin/33 moved to P4; Ankara/06 and İstanbul/34 `hydrographyNoteTr`
 * moved to P6; CONTENT-W4 then moved İstanbul/34 `landformNoteTr` plus Gaziantep/27,
 * Konya/42 and Kayseri/38 `settlementNoteTr` to P8. The count here tracks what this entry point
 * CHECKS today, not what it originally shipped.
 *
 ...
 *     six of the deterministic A.6 swaps remain owned here after later transfers). That count
 *     was itself an undercount — a literal-string scan cannot see the variants
 *     PR #96 (P4) repairs;
